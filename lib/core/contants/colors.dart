...
class AppColors {
  ...
  static const eventContainerColor = Color.fromARGB(255, 239, 249, 255);
  static const dateContainerColor = Color(0xffececec);

  static const flChartBackgroundColor = Color.fromARGB(255, 242, 250, 255);

  static const e21Color = Color.fromARGB(255, 255, 217, 208);
